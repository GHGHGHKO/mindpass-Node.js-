...
for i in classification_rows:
    if i['cloth_big'] == 'top':
        ...
        clothes_hash_top[i['cloth'], i['color']] = i['image']
#        clothes_hash_top[i['cloth']] = i['color']
    elif i['cloth_big'] == 'pants':
        #clothes_hash_pants[i['cloth']] = [i['color'], i['image']]
        clothes_hash_pants[i['cloth'], i['color']] = i['image']
#        clothes_hash_pants[i['cloth']] = i['color']
    elif i['cloth_big'] == 'shoes':
        #clothes_hash_shoes[i['cloth']] = [i['color'], i['image']]
        clothes_hash_shoes[i['cloth'], i['color']] = i['image']
#        clothes_hash_shoes[i['cloth']] = i['color']
    elif i['cloth_big'] == 'bag':
        #clothes_hash_bag[i['cloth']] = [i['color'], i['image']]
        clothes_hash_bag[i['cloth'], i['color']] = i['image']
#        clothes_hash_bag[i['cloth']] = i['color']
    elif i['cloth_big'] == 'coat':
        #clothes_hash_coat[i['cloth']] = [i['color'], i['image']]
        clothes_hash_coat[i['cloth'], i['color']] = i['image']
    ...
    for pants_list in clothes_hash_pants.items():
        for clothes_list in clothes_rows:
            for color_list in color_rows:
                ...
                # ==== 상의, 하의 ====
                if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']):
                    if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                ...
                for shoes_list in clothes_hash_shoes.items():
                    if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (shoes_list[0][0] == clothes_list['shoes']):
                        if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                            #print (top_list, pants_list)
                    ...
                    for bag_list in clothes_hash_bag.items():
                        if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (shoes_list[0][0] == clothes_list['shoes']) and (bag_list[0][0] == clothes_list['bag']):
                            if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                                #print (top_list, pants_list)
                ...
                # ==== 상의, 하의, 가방 ====
                for bag_list in clothes_hash_bag.items():
                    if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (bag_list[0][0] == clothes_list['bag']):
                        if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                            #print (top_list, pants_list)
                    ...
                    for coat_list in clothes_hash_coat.items():
                        if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (bag_list[0][0] == clothes_list['bag']) and (coat_list[0][0] == clothes_list['coat']):
                            if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                                #print (top_list, pants_list)
                ...
                # ==== 상의, 하의, 코트 ====
                for coat_list in clothes_hash_coat.items():
                    if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (coat_list[0][0] == clothes_list['coat']):
                        #if (top_list[1] == color_list['color1']) and (pants_list[1] == color_list['color2']):
                        if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']) and (coat_list[0][1] == color_list['color3']):
                            #print (top_list, pants_list)
                    ...
                    # ==== 상의, 하의, 신발, 코트 ====
                    for shoes_list in clothes_hash_shoes.items():
                        if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (shoes_list[0][0] == clothes_list['shoes']) and (coat_list[0][0] == clothes_list['coat']):
                            if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                                #print (top_list, pants_list)
                        ...
                        # ==== 상의, 하의, 신발, 가방, 코트 ====
                        for bag_list in clothes_hash_bag.items():
                            if (top_list[0][0] == clothes_list['top']) and (pants_list[0][0] == clothes_list['pants']) and (shoes_list[0][0] == clothes_list['shoes']) and (bag_list[0][0] == clothes_list['bag']) and (coat_list[0][0] == clothes_list['coat']):
                                if (top_list[0][1] == color_list['color1']) and (pants_list[0][1] == color_list['color2']):
                                    #print (top_list, pants_list)
