...
classification_sql = "select color, cloth, cloth_big, image from admin"
...
for top_list in clothes_top:
    for pants_list in clothes_pants:
        for clothes_list in clothes_rows: #의류 종류(셔츠, 맨투맨 등)
            for color_list in color_rows: #색상 종류(노랑색, 파랑색 등)
                # ==== 상의, 하의 ====
                ...
                # ==== 상의, 하의, 신발 ====
                for shoes_list in clothes_shoes:
